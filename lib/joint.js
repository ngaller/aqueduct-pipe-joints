...
const {matches, optional} = require('simplecheck')
...
module.exports = function joint(options) {
  if(!check(options, {
    ...
    parentFieldName: optional(String),
    parentFields: optional([String]),
    relatedListName: optional(String),
    relatedListFields: optional([String])
  })) {
    throw new Error('Missing or invalid parameter to joint')
  }
